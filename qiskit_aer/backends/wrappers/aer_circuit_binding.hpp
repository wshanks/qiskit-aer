...
void bind_aer_circuit(MODULE m) {
  ...
  py::native_enum<Operations::UnaryOp>(m, "AerUnaryOp", "enum.Enum", "Internal Aer UnaryOp class")
      .value("BitNot", Operations::UnaryOp::BitNot)
      .value("LogicNot", Operations::UnaryOp::LogicNot)
      .finalize();

  py::native_enum<Operations::BinaryOp>(m, "AerBinaryOp", "enum.Enum", "Internal Aer BinaryOp class")
  ...
  aer_cast_expr.def(
      py::init<const std::shared_ptr<Operations::ScalarType>,
  ...
  aer_uint_expr.def(py::init<const size_t, const uint_t>(),
                    py::arg("width"), py::arg("val"));
  ...
  aer_unary_expr.def(
      py::init<const Operations::UnaryOp,
               const std::shared_ptr<Operations::CExpr>>(),
  ...
  aer_binary_expr.def(
      py::init<const Operations::BinaryOp,
               const std::shared_ptr<Operations::CExpr>,
               const std::shared_ptr<Operations::CExpr>>(),
